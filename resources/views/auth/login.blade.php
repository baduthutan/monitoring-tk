...
<main class="form-signin w-100 m-auto">
  <form method="post" action="{{ url('/login') }}">
    @csrf
    <img class="mb-3" src="https://2.bp.blogspot.com/-hK8ghhQjJvY/VxuT0L8rz1I/AAAAAAAAW_k/wKz84QxhN0oxHFBiU8m9aW8g6e9q5CMzwCLcB/s320/Logo%2BTaman%2BKanak%2BKanak.png" alt="logotk" width="108" height="108">
    ...
    <p class="mt-4 mb-3 text-muted">&copy; TK Bina Insan 2022-2023</p>
  </form>
</main>
